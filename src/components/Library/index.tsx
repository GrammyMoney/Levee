...
import { getDirName, getFileName, getParentDir, normalizePath } from '../../domain/path';
...
export default function Library({
  ...
  const curDriveRoot =
    allDrives.find((d) => d.toLowerCase().startsWith(curDriveLetter.toLowerCase())) ??
            ...
            {listing?.subdirs.map((dir) => {
              ...
              return (
                ...
                >
                  ...
                  {dirSuite && dirCached && (
                    <CloudCheckIcon size={11} className={`shrink-0 ${a.textStrong}`} />
                  )}
                </button>
              );
            })}
                          ...
                          title={
                            !isSuite
                              ...
                              : cacheLoading
                                ? 'Working…'
                                : folderCached
                                  ? `${folderVerb.done} via parent folder`
                                  : cached
                                    ? `${folderVerb.done} — click to remove`
                          ...
                          className={`w-5 h-5 flex items-center justify-center rounded transition-colors ${
                            !isSuite
                              ...
                              : cacheLoading
                                ...
                                : folderCached
                                  ? `${a.textStrong} cursor-default`
                                  : cached
                                    ? `${a.textStrong} hover:text-red-400`

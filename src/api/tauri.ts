...
export function setDriveProviders(providers: Record<string, string>): Promise<void> {
  return invoke<void>('set_drive_providers', { providers });
}

export function precacheList(): Promise<string[]> {
  return invoke<string[]>('precache_list');
}

export function precacheAdd(paths: string[]): Promise<void> {
  return invoke<void>('precache_add', { paths });
}

export function precacheRemove(paths: string[]): Promise<void> {
  return invoke<void>('precache_remove', { paths });
}
